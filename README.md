...
Demo
Frontend: nextesk-web.vercel.app
...
src/ └── main/ └── java/com/taskman/nextesk/ ├── controller/ # Controladores REST ├── model/ # Entidades JPA ├── repository/ # Camada de acesso a dados └── service/ # Regras de negócio
